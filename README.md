...
> The latest release of Orion-LD is [1.2.1](https://github.com/FIWARE/context.Orion-LD/releases/tag/1.2.1) from May 2023
...
[1.2.1](https://github.com/FIWARE/context.Orion-LD/releases/tag/1.2.1)

```console
docker run quay.io/fiware/orion-ld:1.2.1
```
